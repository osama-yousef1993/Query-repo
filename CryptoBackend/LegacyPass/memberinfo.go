...
type MemberInfo struct {
	...
	DisplayName      string    `json:"display_name"`      //diplay name a user chose
	Grants           []Grant   `grants:"grants"`          //An array of granted products
}
