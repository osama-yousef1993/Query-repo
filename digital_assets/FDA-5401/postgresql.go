...
type FundamentalsNFTSalesData struct {
	...
	AVGVolumeUSD1d           bigquery.NullFloat64 `postgres:"avg_volume_usd_1d" json:"avg_volume_usd_1d,omitempty" bigquery:"avg_volume_usd_1d"`
	AVGVolumeNative1d        bigquery.NullFloat64 `postgres:"avg_volume_native_1d" json:"avg_volume_native_1d,omitempty" bigquery:"avg_volume_native_1d"`
	...
	AVGVolumeUSD7d           bigquery.NullFloat64 `postgres:"avg_volume_usd_7d" json:"avg_volume_usd_7d,omitempty" bigquery:"avg_volume_usd_7d"`
	AVGVolumeNative7d        bigquery.NullFloat64 `postgres:"avg_volume_native_7d" json:"avg_volume_native_7d,omitempty" bigquery:"avg_volume_native_7d"`
	...
	AVGVolumeUSD30d           bigquery.NullFloat64 `postgres:"avg_volume_usd_30d" json:"avg_volume_usd_30d,omitempty" bigquery:"avg_volume_usd_30d"`
	AVGVolumeNative30d        bigquery.NullFloat64 `postgres:"avg_volume_native_30d" json:"avg_volume_native_30d,omitempty" bigquery:"avg_volume_native_30d"`
	...
	AVGVolumeUSD90d           bigquery.NullFloat64 `postgres:"avg_volume_usd_90d" json:"avg_volume_usd_90d,omitempty" bigquery:"avg_volume_usd_90d"`
	AVGVolumeNative90d        bigquery.NullFloat64 `postgres:"avg_volume_native_90d" json:"avg_volume_native_90d,omitempty" bigquery:"avg_volume_native_90d"`
	...
	AVGVolumeUSDYtd           bigquery.NullFloat64 `postgres:"avg_volume_usd_ytd" json:"avg_volume_usd_ytd,omitempty" bigquery:"avg_volume_usd_ytd"`
	AVGVolumeNativeYtd        bigquery.NullFloat64 `postgres:"avg_volume_native_ytd" json:"avg_volume_native_ytd,omitempty" bigquery:"avg_volume_native_ytd"`
}
