...
func CombineFundamentalsCG(ctxO context.Context, ticker CoinsMarketResult, highLows PGFundamentalsResult, metadata AssetMetaData, exchangeData []ExchangeBasedFundamentals, allSlugToSymbolMap rfCommon.ConcurrentMap[string, string], oldFundamental Fundamentals, dateAdded PGFundamentalsResult) (Fundamentals, error) {
	...
	// assets date added
	fundamental.DateAdded = dateAdded.DateAdded
