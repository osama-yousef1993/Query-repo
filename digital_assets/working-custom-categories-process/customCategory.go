...
type CustomCategoryRequest struct {
	...
	PlatformId      string  `json:"platformId,omitempty" firestore:"platformId"`           // PlatformId will introduce the custom category name too
...
type CustomCategory struct {
	...
	CategoryFields interface{} `json:"categoryFields" postgresql:"category_fields"` // It presents the markets we will added to custom category
