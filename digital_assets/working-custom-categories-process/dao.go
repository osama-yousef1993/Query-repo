...
type DAO interface {
	...
	NewExchangeQuery() ExchangeQuery                         // Queries for Exchange Functionality
	...
	NewCustomCategoryQuery() CustomCategoryQuery             //Queries for FDA Custom Categories
}
...
// returns a new Custom Category Query object
func (d *dao) NewCustomCategoryQuery() CustomCategoryQuery {
	return &customCategoryQuery{}
}
