...
type CustomNFT struct {
	PlatformId string   `json:"platformId" postgres:"platformId"` // Small image version for NFT
	NFTIds     []string `json:"nftIds" postgres:"nftIds"`         // Large image version for NFT
}
