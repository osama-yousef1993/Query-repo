...
type CacheService interface {
	...
	SearchTerm(context.Context, string, dto.Paginate) (*[]byte, int, error)                                                              // A function that searches the cached data and calls paginateSortAssets to sort the data
...
// A caching service used for our Assets fundamentals
...
func NewAssetsService(dao repository.DAO) CacheService {
...
func (c *categoriesTableCacheService) SearchTerm(ctx context.Context, searchTerm string, paginate dto.Paginate) (*[]byte, int, error) {
...
// BuildCache Attempts to Build FT cached data
...
func (a *assetsService) BuildCache(ctx context.Context) error {
	...
	dictionaryCategoriesAssets, _ = a.BuildCategoryAssetsCache(ctx, categories, assets)
