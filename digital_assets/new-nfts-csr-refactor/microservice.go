...
type Microservices struct {
	...
	nftsPriceService     services.NFTsPriceService          // Provides all functionality to power the NFTs page
}
...
func NewMicroservices(
	...
	nftsPriceService services.NFTsPriceService,
) (*Microservices, error) {
	...
	ms := Microservices{
		...
		nftsPriceService:     nftsPriceService,
	}
