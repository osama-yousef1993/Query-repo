...
type BQExchangesTickers struct {
	Forbes_id string            `bigquery:"forbes_id" json:"forbes_id"` //id of the exchange
	ID        string            `bigquery:"id" json:"id"`               //id of the exchange
	Name      string            `bigquery:"name" json:"name"`           //name of exchange
	Tickers   []BQTicker        `bigquery:"tickers" json:"tickers"`     //list of tickers
	Source    common.DataSource `bigquery:"source" json:"source"`       //source of the data
}
...
type ExchangeSubmission struct {
	...
	Source common.DataSource `json:"source" firestore:"source" postgres:"source"`
}
